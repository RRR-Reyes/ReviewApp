...
export default function DiscretePage() {
  ...
  const currentSet = useMemo(() => {
    if (activeModule === "Module 1: Logic & Arithmetic")
  ...
  const mathSymbols = useMemo(() => {
    if (activeModule === "Module 3: Functions") {
      return ["⁻¹", "⌊", "⌋", "⌈", "⌉", "ℝ", "ℤ", "ℚ", "ℕ", "∘"];
    }
    if (activeModule === "Module 4: Cryptography") {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {[
              { name: "Module 1: Logic & Arithmetic", emoji: "🧮" },
              ...
              {subtopics.map((subtopic) => (
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    background:
                      selectedSubtopic === subtopic ? "#0072ff" : "white",
        ...
        {currentQuestion ? (
                ...
                {mathSymbols.map((sym) => (
                  <button
                    ...
                    style={{
                      ...
                      fontSize: "1.05rem",
                      minWidth:
                        activeModule === "Module 4: Cryptography"
                          ? "44px"
                          : "auto",
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.borderColor = "#0072ff";
                    }}
                    onMouseLeave={(e) => {
          ...
          >
            ...
            <h3
              style={{ fontSize: "2rem", color: "#2d3748", fontWeight: "800" }}
            >
